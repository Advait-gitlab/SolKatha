...
const IntroPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-purple-900 to-teal-500 text-white">
      <h1 className="text-4xl mb-6">Welcome to Sólkatha</h1>
      <p className="text-center max-w-md mb-8">
        Sólkatha is your mental wellness companion, inspired by the wisdom of Krishna and Arjuna. Embark on a journey of emotional support and self-discovery with personalized guidance.
      </p>
