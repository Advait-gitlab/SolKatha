...
const Dashboard = () => {
  ...
  if (!user) {
    return <div className="flex items-center justify-center h-screen bg-gradient-to-b from-purple-900 to-teal-500 text-white">Please log in to access the dashboard.</div>;
  }
