...
`;
    ...
    const formatted = formatUserResponse(rawText);

    return { response: formatted, verse: wantsVerse ? verse : null };
  } catch (err) {
    console.error("Gemini API error:", err);
    return {
      response: "I am with you, but something went wrong. Please try again.",
      verse: null,
    };
  }
};
